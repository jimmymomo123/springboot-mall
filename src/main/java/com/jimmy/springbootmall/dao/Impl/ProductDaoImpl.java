...
import com.jimmy.springbootmall.rowmapper.ProductRowMapper;
...
public class ProductDaoImpl implements ProductDao {
    ...
    public Integer createProduct(ProductRequest productRequest) {
        String sql = "insert into product(product_name, category, image_url, price, " +
                "stock, description, created_date, last_modified_date) values(:productName," +
                " :category, :imageUrl, :price, :stock, :description, :createdDate, :lastModifiedDate)";
